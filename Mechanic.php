...
<section>
  ...
  <article>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
        <fieldset>
            <br>
        <input type="submit" name="addMechanicBtn" value="Add Mechanic" /><br><br>

        <input type="submit" name="listBtn" value="Mechanic List" /><br><br>
        </fieldset>
    </form>
	...
	<?php
        if(array_key_exists('addMechanicBtn', $_POST)) {
            addMechanic();
        }
